document.addEventListener('DOMContentLoaded', () => {
    ...
    if (query) {
        ...
        cards.forEach(card => {
            ...
            const searchableText = (card.getAttribute('href') + imgAlt).toLowerCase();
        ...
        resultMsg.className = 'container search-result-msg';
        resultMsg.innerHTML = `「${query}」の検索結果: ${matchCount}件`;
